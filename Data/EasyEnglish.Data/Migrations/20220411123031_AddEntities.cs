    ...
    public partial class AddEntities : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserLanguage", x => new { x.LanguagesId, x.TeachersId });
                    table.ForeignKey(
                        name: "FK_ApplicationUserLanguage_AspNetUsers_TeachersId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CourseTypes_Languages_LanguageId",
                        column: x => x.LanguageId,
                        principalTable: "Languages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CourseTypes_Levels_LevelId",
                        column: x => x.LevelId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrainingFormId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Courses_TrainingForms_TrainingFormId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrainingFormId = table.Column<int>(type: "int", nullable: true),
                    CourseTypeId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Prices_CourseTypes_CourseTypeId",
                        column: x => x.CourseTypeId,
                        principalTable: "CourseTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Prices_TrainingForms_TrainingFormId",
                        column: x => x.TrainingFormId,
                        principalTable: "TrainingForms",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ResourceCourseTypes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ResourceCourseTypes_CourseTypes_CourseTypeId",
                        column: x => x.CourseTypeId,
                        principalTable: "CourseTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ResourceCourseTypes_Resources_ResourceId",
                        column: x => x.ResourceId,
                        principalTable: "Resources",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserCourse", x => new { x.StudentCoursesId, x.StudentsId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ApplicationUserCourse_Courses_StudentCoursesId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaidFor = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    CourseId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HomeworkResource", x => new { x.HomeworksId, x.ResourcesId });
                    table.ForeignKey(
                        name: "FK_HomeworkResource_Homeworks_HomeworksId",
                        column: x => x.HomeworksId,
                        principalTable: "Homeworks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_HomeworkResource_Resources_ResourcesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserLanguage_TeachersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Courses_TrainingFormId",
                table: "Courses",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseTypes_LanguageId",
                table: "CourseTypes",
                column: "LanguageId");

            migrationBuilder.CreateIndex(
                name: "IX_CourseTypes_LevelId",
                table: "CourseTypes",
                column: "LevelId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HomeworkResource_ResourcesId",
                table: "HomeworkResource",
                column: "ResourcesId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Prices_TrainingFormId",
                table: "Prices",
                column: "TrainingFormId");

            migrationBuilder.CreateIndex(
                name: "IX_ResourceCourseTypes_CourseTypeId",
                table: "ResourceCourseTypes",
                column: "CourseTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_ResourceCourseTypes_IsDeleted",
                table: "ResourceCourseTypes",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_ResourceCourseTypes_ResourceId",
                table: "ResourceCourseTypes",
                column: "ResourceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrainingForms_IsDeleted",
                table: "TrainingForms",
                column: "IsDeleted");
